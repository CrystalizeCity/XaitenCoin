...
* xaitencoin.conf: contains configuration settings for xaitencoind or xaitencoin-qt
* xaitencoind.pid: stores the process id of xaitencoind while running
...
* debug.log: contains debug information and general logging generated by xaitencoind or xaitencoin-qt
