...
"""Verify that starting xaitencoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xaitencoin with -h for help text")
        ...
        self.log.info("Start xaitencoin with -version for version information")
