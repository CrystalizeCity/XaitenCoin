...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 26425
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 26426
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 36425
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 36426
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 26425
	%{_sbindir}/semanage port -d -p tcp 26426
	%{_sbindir}/semanage port -d -p tcp 36425
	%{_sbindir}/semanage port -d -p tcp 36426
