...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xaitencoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xaitencoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xaitencoin transaction") + "\n" +
              "  xaitencoin-tx [options] -create [commands]   " + _("Create hex-encoded xaitencoin transaction") + "\n" +
              "\n";
